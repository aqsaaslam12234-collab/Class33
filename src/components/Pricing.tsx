const Pricing = () => {
  return (
    <div className=" mt-130">
      <h1 className="font-bold text-4xl content-center text-teal-950 ">
        Pricing
      </h1>
      ...
      <div className="content-center mt-4 ">
        <button className="bg-teal-500 text-white w-30 h-11 rounded-l-lg">
          Monthly
        </button>
        <button className="focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50 text-teal-700 w-30 h-10 rounded-r-lg">
          Annualy
        </button>
      </div>
